...
import type {
  StockLedgerRow,
  StockLedgerPdfProps,
  AmountPayableBreakdownLine,
  AmountPayableRowBreakdown,
} from './stockLedgerPdfTypes';
import {
  SIZE_HEADER_LABELS,
  formatWeight,
  roundUpToMultipleOf10,
 ...
 */
function getAmountPayableBreakdown(
  row: StockLedgerRow
