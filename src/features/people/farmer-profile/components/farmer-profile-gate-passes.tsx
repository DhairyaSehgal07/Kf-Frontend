...
const GATE_PASS_TABS = [
  ...
  },
  {
    ...
    icon: PackageCheck,
    emptyTitle: "No dispatch (pre-storage) gate passes",
  ...
  },
  {
    ...
    icon: ArrowLeftRight,
    emptyTitle: "No dispatch (post-storage) gate passes",
    emptyDescription:
      "Outgoing dispatch gate passes for this farmer will appear here.",
